...
{
    public class UpdateCategoryTypeHandler : BaseHandler<UpdateCategoryTypeHandler>
    {
        private ICategoryTypeBusinessService service;
        private readonly ILogger<UpdateCategoryTypeHandler> logger;
        ...
        public UpdateCategoryTypeHandler(ILogger<UpdateCategoryTypeHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
