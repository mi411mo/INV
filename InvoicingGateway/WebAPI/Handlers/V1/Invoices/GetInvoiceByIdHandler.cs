...
{
    public class GetInvoiceByIdHandler : BaseHandler<GetInvoiceByIdHandler>
    {
        private IInvoiceBusinessService service;
        private readonly ILogger<GetInvoiceByIdHandler> logger;
        ...
        public GetInvoiceByIdHandler(ILogger<GetInvoiceByIdHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
