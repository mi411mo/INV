...
{
    public class GetAllCategoryTypesHandler : BaseHandler<GetAllCategoryTypesHandler>
    {
        private ICategoryTypeBusinessService service;
        private readonly ILogger<GetAllCategoryTypesHandler> logger;
        ...
        public GetAllCategoryTypesHandler(ILogger<GetAllCategoryTypesHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
