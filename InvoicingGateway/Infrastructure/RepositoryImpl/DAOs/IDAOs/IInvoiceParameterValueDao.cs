...
{
    public interface IInvoiceParameterValueDao
    {
        Task<bool> InsertAsync(InvoiceCustomValue mdl, DataAccessRepository daRpst);
        ...
        Task<bool> Update(int id, InvoiceCustomValue mdl, DataAccessRepository daRpst);
