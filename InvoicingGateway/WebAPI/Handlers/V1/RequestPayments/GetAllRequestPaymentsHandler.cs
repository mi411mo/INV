...
{
    public class GetAllRequestPaymentsHandler : BaseHandler<GetAllRequestPaymentsHandler>
    {
        private IRequestPaymentBusinessService service;
        private readonly ILogger<GetAllRequestPaymentsHandler> logger;
        ...
        public GetAllRequestPaymentsHandler(ILogger<GetAllRequestPaymentsHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
