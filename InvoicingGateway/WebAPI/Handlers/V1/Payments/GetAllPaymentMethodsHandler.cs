...
{
    public class GetAllPaymentMethodsHandler : BaseHandler<GetAllPaymentMethodsHandler>
    {
        private IPaymentBusinessService service;
        private readonly ILogger<GetAllPaymentMethodsHandler> logger;
        ...
        public GetAllPaymentMethodsHandler(ILogger<GetAllPaymentMethodsHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            var serviceResponse = await service.GetPaymentMethods(generalFilter, base.SendAsync, request, cancellationToken);

            var responseTxt = JSONHelper<RestAPIGenericResponseDTO<PaymentMethodsResponseDto>>.GetJSONStr(serviceResponse);
