...
{
    public class CreateMerchantHandler : BaseHandler<CreateMerchantHandler>
    {
        private IMerchantBusinessService service;
        private readonly ILogger<CreateMerchantHandler> logger;
