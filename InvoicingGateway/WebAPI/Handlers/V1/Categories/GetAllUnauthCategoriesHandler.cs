...
{
    public class GetAllUnauthCategoriesHandler : BaseHandler<GetAllUnauthCategoriesHandler>
    {
        private ICategoryBusinessService service;
        private readonly ILogger<GetAllUnauthCategoriesHandler> logger;
        ...
        public GetAllUnauthCategoriesHandler(ILogger<GetAllUnauthCategoriesHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
        ...
        {
            //var response = await _authorizationHelper.ValidateUserPermissionsAsync(Policy.Invoicing.InfoInvoicesCategories + "||"+ Policy.Invoicing.DetailsInvoicesCategories);
            ...
            generalFilter.CustomerId = Constants.ADMIN_CUSTOMER_ID;
