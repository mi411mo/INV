...
{
    public class GetAllUnauthProductsHandler : BaseHandler<GetAllUnauthProductsHandler>
    {
        private IProductBusinessService service;
        private readonly ILogger<GetAllUnauthProductsHandler> logger;
        ...
        public GetAllUnauthProductsHandler(ILogger<GetAllUnauthProductsHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
        ...
        {
            //var authResponse = await _authorizationHelper.ValidateUserPermissionsAsync(Policy.Invoicing.ViewProducts + "||" + Policy.Invoicing.InfoProducts);
