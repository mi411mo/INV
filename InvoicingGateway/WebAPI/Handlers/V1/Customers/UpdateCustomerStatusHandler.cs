...
{
    public class UpdateCustomerStatusHandler : BaseHandler<UpdateCustomerStatusHandler>
    {
        private ICustomerBusinessService service;
        private readonly ILogger<UpdateCustomerStatusHandler> logger;
        ...
        public UpdateCustomerStatusHandler(ILogger<UpdateCustomerStatusHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
