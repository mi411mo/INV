...
{
    public class UpdateCategoryStatusHandler : BaseHandler<UpdateCategoryStatusHandler>
    {
        private ICategoryBusinessService service;
        private readonly ILogger<UpdateCategoryStatusHandler> logger;
        ...
        public UpdateCategoryStatusHandler(ILogger<UpdateCategoryStatusHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
        ...
        {
            var authResponse = await _authorizationHelper.ValidateUserPermissionsAsync(Policy.Invoicing.ManageInvoicesCategories);
