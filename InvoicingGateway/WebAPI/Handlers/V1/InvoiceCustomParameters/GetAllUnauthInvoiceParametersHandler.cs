...
{
    public class GetAllUnauthInvoiceParametersHandler : BaseHandler<GetAllUnauthInvoiceParametersHandler>
    {
        private IInvoiceParameterBusinessService service;
        private readonly ILogger<GetAllUnauthInvoiceParametersHandler> logger;
        ...
        public GetAllUnauthInvoiceParametersHandler(ILogger<GetAllUnauthInvoiceParametersHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
