...
{
    public class CreateUnauthMerchantHandler : BaseHandler<CreateUnauthMerchantHandler>
    {
        private IMerchantBusinessService service;
        private readonly ILogger<CreateUnauthMerchantHandler> logger;
        ...
        public CreateUnauthMerchantHandler(InputValidationService inputValidationService, ILogger<CreateUnauthMerchantHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            var jSONValidationResponse = await inputValidationService.Validate<MerchantRequestDto>(jSONstring);
            ...
            serviceRequest.CustomerId = Constants.ADMIN_CUSTOMER_ID;
