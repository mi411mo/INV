...
{
    public class GetRequestPaymentByIdHandler : BaseHandler<GetRequestPaymentByIdHandler>
    {
        private IRequestPaymentBusinessService service;
        private readonly ILogger<GetRequestPaymentByIdHandler> logger;
        ...
        public GetRequestPaymentByIdHandler(ILogger<GetRequestPaymentByIdHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                if (request.RequestUri.Segments.Length == 4)
                {
                    ...
                    int id = ccode; // set request payment id
