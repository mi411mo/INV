...
{
    public class UpdatePaymentRequestStatusHandler : BaseHandler<UpdatePaymentRequestStatusHandler>
    {
        private IRequestPaymentBusinessService service;
        private readonly ILogger<UpdatePaymentRequestStatusHandler> logger;
        ...
        public UpdatePaymentRequestStatusHandler(ILogger<UpdatePaymentRequestStatusHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
