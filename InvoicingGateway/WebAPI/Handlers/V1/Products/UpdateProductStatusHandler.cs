...
{
    public class UpdateProductStatusHandler : BaseHandler<UpdateProductStatusHandler>
    {
        private IProductBusinessService service;
        private readonly ILogger<UpdateProductStatusHandler> logger;
        ...
        public UpdateProductStatusHandler(ILogger<UpdateProductStatusHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
