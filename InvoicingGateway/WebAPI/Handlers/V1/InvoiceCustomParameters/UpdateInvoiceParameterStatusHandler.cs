...
{
    public class UpdateInvoiceParameterStatusHandler : BaseHandler<UpdateInvoiceParameterStatusHandler>
    {
        private IInvoiceParameterBusinessService service;
        private readonly ILogger<UpdateInvoiceParameterStatusHandler> logger;
        ...
        public UpdateInvoiceParameterStatusHandler(ILogger<UpdateInvoiceParameterStatusHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
        ...
        {
            var authResponse = await _authorizationHelper.ValidateUserPermissionsAsync(Policy.Invoicing.ManageInvoiceCustomParameters);
