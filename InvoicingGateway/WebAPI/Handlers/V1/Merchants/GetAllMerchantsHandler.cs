...
{
    public class GetAllMerchantsHandler : BaseHandler<GetAllMerchantsHandler>
    {
        private IMerchantBusinessService service;
        private readonly ILogger<GetAllMerchantsHandler> logger;
        ...
        public GetAllMerchantsHandler(ILogger<GetAllMerchantsHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
