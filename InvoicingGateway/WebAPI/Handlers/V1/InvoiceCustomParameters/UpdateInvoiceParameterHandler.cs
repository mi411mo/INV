...
{
    public class UpdateInvoiceParameterHandler : BaseHandler<UpdateInvoiceParameterHandler>
    {
        private IInvoiceParameterBusinessService service;
        private readonly ILogger<UpdateInvoiceParameterHandler> logger;
        ...
        public UpdateInvoiceParameterHandler(ILogger<UpdateInvoiceParameterHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
