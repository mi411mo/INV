...
{
    public class DeleteProductHandler : BaseHandler<DeleteProductHandler>
    {
        ...
        public DeleteProductHandler(ILogger<DeleteProductHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
