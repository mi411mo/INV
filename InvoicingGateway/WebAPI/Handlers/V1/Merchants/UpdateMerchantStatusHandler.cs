...
{
    public class UpdateMerchantStatusHandler : BaseHandler<UpdateMerchantStatusHandler>
    {
        private IMerchantBusinessService service;
        private readonly ILogger<UpdateMerchantStatusHandler> logger;
        ...
        public UpdateMerchantStatusHandler(ILogger<UpdateMerchantStatusHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            if (request.RequestUri.Segments.Length == 5)
            {
                ...
                int status = cstatus;   // set merchant status
