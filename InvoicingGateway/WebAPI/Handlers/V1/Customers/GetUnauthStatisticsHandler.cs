...
{
    public class GetUnauthStatisticsHandler : BaseHandler<GetUnauthStatisticsHandler>
    {
        ...
        private readonly ILogger<GetUnauthStatisticsHandler> logger;
        ...
        public GetUnauthStatisticsHandler(ILogger<GetUnauthStatisticsHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
