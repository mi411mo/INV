...
{
    public class GetAllUnauthRequestPaymentsHandler : BaseHandler<GetAllUnauthRequestPaymentsHandler>
    {
        private IRequestPaymentBusinessService service;
        private readonly ILogger<GetAllUnauthRequestPaymentsHandler> logger;
        ...
        public GetAllUnauthRequestPaymentsHandler(ILogger<GetAllUnauthRequestPaymentsHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
