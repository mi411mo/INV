...
{
    public class DeleteInvoiceParameterHandler : BaseHandler<DeleteInvoiceParameterHandler>
    {
        private IInvoiceParameterBusinessService service;
        private readonly ILogger<DeleteInvoiceParameterHandler> logger;
        private readonly IHttpContextAccessor httpContextAccessor;
        private int id;
        private readonly AuthorizationHelper _authorizationHelper;

        public DeleteInvoiceParameterHandler(ILogger<DeleteInvoiceParameterHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
