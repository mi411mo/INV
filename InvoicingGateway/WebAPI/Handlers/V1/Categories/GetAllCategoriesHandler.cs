...
{
    public class GetAllCategoriesHandler :BaseHandler<GetAllCategoriesHandler>
    {
        private ICategoryBusinessService service;
        private readonly ILogger<GetAllCategoriesHandler> logger;
        ...
        public GetAllCategoriesHandler(ILogger<GetAllCategoriesHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
