...
{
    public interface IInvoiceParameterDao
    {
        Task<bool> InsertAsync(InvoiceCustomParameter mdl, DataAccessRepository daRpst);
        ...
        Task<bool> Update(int id, InvoiceCustomParameter mdl, DataAccessRepository daRpst);
