...
{
    public class GetAllLogsHandler : BaseHandler<GetAllLogsHandler>
    {
        private ILogService service;
        private readonly ILogger<GetAllLogsHandler> logger;
        ...
        public GetAllLogsHandler(ILogger<GetAllLogsHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
        ...
        {
            //TODO:Add a new Policy for View logs
            ...
            service = httpContextAccessor.HttpContext.RequestServices.GetRequiredService<ILogService>();
            ...
            var serviceResponse = new RestAPIGenericResponseDTO<Log>().WithSuccess(Constants.THARWAT_SUCCESS_CODE, Constants.SUCCESS_Message, logsList);
            var responseTxt = JSONHelper<RestAPIGenericResponseDTO<Log>>.GetJSONStr(serviceResponse);
