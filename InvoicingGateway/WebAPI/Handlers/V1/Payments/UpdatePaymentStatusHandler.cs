...
{
    public class UpdatePaymentStatusHandler :  BaseHandler<UpdatePaymentStatusHandler>
    {
        private IInvoiceBusinessService service;
        private readonly ILogger<UpdatePaymentStatusHandler> logger;
        ...
        public UpdatePaymentStatusHandler(ILogger<UpdatePaymentStatusHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
