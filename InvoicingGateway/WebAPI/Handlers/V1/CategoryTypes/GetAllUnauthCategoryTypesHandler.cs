...
namespace WebAPI.Handlers.V1.CategoryTypes
{
    public class GetAllUnauthCategoryTypesHandler : BaseHandler<GetAllUnauthCategoryTypesHandler>
    {
        private ICategoryTypeBusinessService service;
        private readonly ILogger<GetAllUnauthCategoryTypesHandler> logger;
        ...
        public GetAllUnauthCategoryTypesHandler(ILogger<GetAllUnauthCategoryTypesHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
        ...
        {
            //var response = await _authorizationHelper.ValidateUserPermissionsAsync(Policy.Invoicing.ViewCategoryTypes + "||" + Policy.Invoicing.InfoCategoryTypes);
