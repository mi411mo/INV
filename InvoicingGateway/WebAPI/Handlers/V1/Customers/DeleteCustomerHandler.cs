...
{
    public class DeleteCustomerHandler : BaseHandler<DeleteCustomerHandler>
    {
        ...
        public DeleteCustomerHandler(ILogger<DeleteCustomerHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
