...
{
    public class GetAllUnauthInvoicesHandler : BaseHandler<GetAllUnauthInvoicesHandler>
    {
        private IInvoiceBusinessService service;
        private readonly ILogger<GetAllUnauthInvoicesHandler> logger;
        ...
        public GetAllUnauthInvoicesHandler(ILogger<GetAllUnauthInvoicesHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
        ...
        {
           /* var response = await _authorizationHelper.ValidateUserPermissionsAsync(Policy.Invoicing.InfoInvoices + "||" + Policy.Invoicing.ViewInvoices);
