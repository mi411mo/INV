...
{
    public class GetAllProductsHandler : BaseHandler<GetAllProductsHandler>
    {
        ...
        public GetAllProductsHandler(ILogger<GetAllProductsHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
