...
{
    public class GetAllInvoiceParametersHandler : BaseHandler<GetAllInvoiceParametersHandler>
    {
        private IInvoiceParameterBusinessService service;
        private readonly ILogger<GetAllInvoiceParametersHandler> logger;
        ...
        public GetAllInvoiceParametersHandler(ILogger<GetAllInvoiceParametersHandler> logger, IHttpClientFactory _httpClientFactory, IHttpContextAccessor accessor, IConfiguration config, AuthorizationHelper _authorizationHelper) : base(logger, _httpClientFactory, accessor, config, _authorizationHelper)
        {
            this.logger = logger;
        ...
        {
            var response = await _authorizationHelper.ValidateUserPermissionsAsync(Policy.Invoicing.InfoInvoiceCustomParameters + "||" + Policy.Invoicing.ViewInvoiceCustomParameters);
